<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <q-layout-header>
      ...
      >
        <q-toolbar-title>
          <span class="cursor-pointer" @click="$router.push({name: 'IndexPage'})">
          {{$t('app_name')}}
          </span>
          <span slot="subtitle" class="cursor-pointer" @click="$router.push({name: 'IndexPage'})">{{$t('app_description')}}</span>
        </q-toolbar-title>
