<template>
  <div class="calendar">
    <q-tabs class="calendar-tabs" ref="fullCalendarTabs" inverted v-model="calendarMode" align="right">
      <q-tab
        name="tab-month"
        icon="view_module"
        :label="$t('month')"
...
export default {
  components: { CalendarMonth, CalendarWeek, CalendarSingleDay, CalendarAgenda },
  name: 'calendar',
  data () {
    return {
      currentTime: 0
